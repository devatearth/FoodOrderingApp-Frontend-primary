        ...
        <div>
          <div className="resMainDiv">
                ...
                <Grid item xs={10}>
                  <div>
                    <ButtonBase className="image" disableRipple={true}>
                      <img
                        id="imageDisplay"
                        alt={this.state.resData.restaurant_name}
                        src={this.state.resData.photo_URL}
                      />
                    </ButtonBase>
                  </div>
                </Grid>
            ...
            <Grid item xs={6} container>
              ...
              >
                <Grid item xs>
                  <Typography className="resName">
                    {this.state.resData.restaurant_name}
                  </Typography>
                  <Typography id="LocalityCity">
                    {" "}
                    {this.state.locality}-{this.state.city}
                  </Typography>
                  <br />
                  {(this.state.resData.categories || []).map(
                    (category, index) => {
                      return (
                        <Typography
                          key={"span" + category.id}
                          display="inline"
                ...
                <Grid item container spacing={5}>
                  <Grid item xs={7}>
                    ...
                    <span
                      className="textResDetails"
                      style={{ display: "block", color: "grey", fontSize: 20 }}
                    >
                      AVERAGE RATING BY
                    </span>
                    <span
                    ...
                    >
                      ...
                      >
                        {this.state.resData.number_customers_rated}{" "}
                      </span>
                      CUSTOMERS
                    </span>
                  </Grid>
            ...
            {(this.state.resData.categories || []).map((category, index) => {
              return (
                <div key={"div" + category.id}>
                  <div key={"sub-div" + category.id} className="categoriesCart">
                    {category.category_name}{" "}
                  </div>
                  <Divider />
                  <br />
          ...
          <div className="myCart">
            <Card className="cardRoot">
              <CardContent className="cardContentRoot">
                ...
                <div>
                  {" "}
                  {(this.state.cartItems.itemList || []).map(
                    (cartItem, index) => (
